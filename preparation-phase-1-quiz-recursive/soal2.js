...
function changeXRecursive(data, jenis) {
    ...
    const indexPertama = data[0]
    const jenisGenap = jenis === 'genap'

    let ubahData = (jenisGenap && indexPertama % 2 === 1) || (!jenisGenap && indexPertama % 2 === 0) ? 'x' : indexPertama;

    return ubahData + changeXRecursive(data.slice(1), jenis)
