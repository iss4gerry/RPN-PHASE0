...
function shoppingTime(memberId, money) {
    ...
    const items = {
      ...
      let totalBelanja = money;
      let itemPurchased = [];
      let bisaBeli = false;
      for (const namaBarang in items) {
        if(totalBelanja >= items[namaBarang]){
          totalBelanja -= items[namaBarang];
          itemPurchased.push(namaBarang);
          bisaBeli = true
        }
      }
